...
use super::infer::{
    ArgOrder, Coercion, DistinctRecv, DynCoerce, FuncCall, FuncCallDeref, FuncCallMethod, Generics,
    Instantiation, MethodDispatch, MethodRes, Promoted, RangeReported, RecvAdjust, SliceCoerce,
    Upcast,
};
