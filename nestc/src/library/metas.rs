...
use crate::sema::infer::{
    ...
    FuncCallMethod, Generics, IndexWrite, Instantiation, MethodRes, OpResolution, OpaqueTy,
    RangeReported, SliceCoerce, StaticTraitSelf, TyPathReported, Upcast, VariantTag,
};
